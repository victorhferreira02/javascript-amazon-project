...
describe("test suite: Clothing", () => {
  ...
  it("has the correct properties", () => {
    ...
    (expect(clothing.id).toEqual("83d4ca15-0f35-48f5-b7a3-1ea210004f2e"), expect(clothing.image).toEqual("images/products/adults-plain-cotton-tshirt-2-pack-teal.jpg"));
...
describe("test suite: Appliance", () => {
  ...
  it("has the correct properties", () => {
    (expect(appliance.id).toEqual("54e0eccd-8f36-462b-b68a-8182611d9add"), expect(appliance.image).toEqual("images/products/black-2-slot-toaster.jpg"));
